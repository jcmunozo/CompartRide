...
from cride.rides.serializers.rides import RideModelSerailizer
...
class RideViewSet(mixins.ListModelMixins,
    ...
    def get_serializer_context(self):
        ...
        data = super(RideViewSet, self).get_serializer_context()
    ...
    def get_serializer_class(self):
        ...
        if selt.action == 'finish':
            return EndRideSerializer
        return RideModelSeralizer

    def get_queryset(self):
        """Retuprn active circle´s rides."""
    ...
    def join(self, request, *args, **kwargs):
        ...
        data = RideModelSerailizer(ride).data
